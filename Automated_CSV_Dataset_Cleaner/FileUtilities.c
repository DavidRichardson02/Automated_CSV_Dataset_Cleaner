...
{
	printf("\n\n\n File Pathname: %-5s", fileProperties.filePathName);
	printf("\n File Name: %-5s", fileProperties.fileName);
	printf("\n File Extension: %-5s", fileProperties.fileExtension);
	printf("\n Lines in File: %-5d\n\n\n\n", fileProperties.fileLineCount);
}
